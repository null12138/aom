    ...
    def _dispatch(self, path: str, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if path == "/api/dream-alpha/start":
            ...
            cfg = {
                ...
                "generation_count": payload.get("generation_count", payload.get("count", 8)),
                ...
                "max_operator_calls": payload.get("max_operator_calls", 12),
                "max_expression_fields": payload.get("max_expression_fields", 12),
                "enable_llm_repair": payload.get("enable_llm_repair", True),
                "repair_attempts": payload.get("repair_attempts", 2),
                "mutation_keep_ratio": payload.get("mutation_keep_ratio", 0.4),
                ...
                "prefer_simple_operators": payload.get("prefer_simple_operators", False),
                "strict_quota_enabled": payload.get("strict_quota_enabled", False),
                "enable_negative_flip": payload.get("enable_negative_flip", True),
                "negative_flip_sharpe_threshold": payload.get("negative_flip_sharpe_threshold", -0.8),
                "negative_flip_fitness_threshold": payload.get("negative_flip_fitness_threshold", -0.15),
                "negative_flip_force_count": payload.get("negative_flip_force_count", 2),
                "negative_flip_max_seeds": payload.get("negative_flip_max_seeds", 8),
                "single_dataset_only": payload.get("single_dataset_only", False),
                "inject_forum_seed_templates": payload.get("inject_forum_seed_templates", True),
                "seed_from_library_db": payload.get("seed_from_library_db", True),
                "library_db_file": str(resolve_path(payload.get("library_db_file") or "db/factor_library.db")),
                "library_seed_limit": payload.get("library_seed_limit", 80),
                "library_seed_min_abs_sharpe": payload.get("library_seed_min_abs_sharpe", 0.0),
                "library_seed_min_fitness": payload.get("library_seed_min_fitness", 1.0),
                ...
                "learning_seed_sharpe_min": payload.get("learning_seed_sharpe_min", 0.2),
                "learning_seed_fitness_min": payload.get("learning_seed_fitness_min", 1.0),
                ...
                "push_all_console_notifications": payload.get("push_all_console_notifications", True),
                ...
                "seed_file": str(resolve_path(payload.get("seed_file") or "generated/dream_alpha_seed_library.json")),
