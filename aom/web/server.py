    ...
    def _dispatch(self, path: str, payload: Dict[str, Any]) -> Dict[str, Any]:
        ...
        if path == "/api/dream-alpha/start":
            ...
            cfg = {
                ...
                "max_expression_fields": payload.get("max_expression_fields", 8),
                ...
                "prefer_simple_operators": payload.get("prefer_simple_operators", True),
                ...
                "learning_seed_fitness_min": payload.get("learning_seed_fitness_min", 0.05),
