...
const ui = {
  ...
  dreamStartMode: document.getElementById('dream_start_mode'),
  ...
  dreamNoSuccessNotifyCooldownSec: document.getElementById('dream_no_success_notify_cooldown_sec'),
  ...
  dreamNoSuccessNotifyEvery: document.getElementById('dream_no_success_notify_every'),
...
const actions = {
  ...
  async dreamStart() {
    ...
    const payload = {
      ...
      report_text: ai.reportText ? ai.reportText.value : '',
      include_patterns: ai.includePatterns ? ai.includePatterns.checked : true,
      generation_count: ui.dreamGenerationCount && ui.dreamGenerationCount.value ? Number(ui.dreamGenerationCount.value) : 8,
      start_mode: ui.dreamStartMode ? String(ui.dreamStartMode.value || 'inherit').trim() : 'inherit',
      simulation_concurrency: 5,
      max_operator_calls: 12,
      max_expression_fields: 12,
      enable_llm_repair: true,
      repair_attempts: 2,
      mutation_keep_ratio: 0.4,
      ...
      no_success_notify_every: ui.dreamNoSuccessNotifyEvery && ui.dreamNoSuccessNotifyEvery.value ? Number(ui.dreamNoSuccessNotifyEvery.value) : 2,
      no_success_notify_cooldown_sec: ui.dreamNoSuccessNotifyCooldownSec && ui.dreamNoSuccessNotifyCooldownSec.value ? Number(ui.dreamNoSuccessNotifyCooldownSec.value) : 180,
      prefer_simple_operators: false,
      strict_quota_enabled: false,
      enable_negative_flip: true,
      negative_flip_sharpe_threshold: -0.8,
      negative_flip_fitness_threshold: -0.15,
      negative_flip_force_count: 2,
      negative_flip_max_seeds: 8,
      single_dataset_only: false,
      inject_forum_seed_templates: true,
      seed_from_library_db: true,
      library_db_file: 'db/factor_library.db',
      library_seed_limit: 80,
      library_seed_min_abs_sharpe: 0.0,
      library_seed_min_fitness: 1.0,
      ...
      learning_seed_sharpe_min: 0.2,
      learning_seed_fitness_min: 1.0,
      push_all_console_notifications: true,
      max_seed_in_prompt: ui.dreamMaxSeedInPrompt && ui.dreamMaxSeedInPrompt.value ? Number(ui.dreamMaxSeedInPrompt.value) : 20,
      seed_file: ui.dreamSeedFile ? ui.dreamSeedFile.value : 'generated/dream_alpha_seed_library.json',
      ...
      notify_url: ui.dreamNotifyUrl
        ? (String(ui.dreamNotifyUrl.value || '').trim() || 'https://tgpusher.opener.eu.org/')
        : 'https://tgpusher.opener.eu.org/',
