...
const actions = {
  ...
  async dreamStart() {
    ...
    const payload = {
      ...
      report_text: ai.reportText ? ai.reportText.value : '',
      include_patterns: ai.includePatterns ? ai.includePatterns.checked : true,
      generation_count: ui.dreamGenerationCount && ui.dreamGenerationCount.value ? Number(ui.dreamGenerationCount.value) : 5,
      start_mode: ui.dreamStartMode ? String(ui.dreamStartMode.value || 'inherit').trim() : 'inherit',
      simulation_concurrency: 5,
      max_operator_calls: 8,
      max_expression_fields: 8,
      ...
      learning_seed_fitness_min: 0.05,
